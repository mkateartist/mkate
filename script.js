(function(){
  ...
  const dict = {
    ru:{
      ...
      delivery_pay_3:"Предоплата для работ из наличия перед отправкой 100%",
      ...
      comm_portrait_note:"Акварель / чёрно‑белый (масло)\nСоздаётся по фотографии с сохранением характера и атмосферы.",
      comm_20x30:"20×30 см",
      comm_30x40:"30×40 см",
      comm_40x50:"40×50 см",
      comm_50x60:"50×60 см",
      comm_extra_face:"+1 лицо на лист — 7 000 ₽",
      comm_photo_title:"Картина по Вашему фото",
    ...
    en:{
      ...
      about_text:"I’m an artist working in watercolor and oil painting.\nMy works explore light, space, and inner states.\nMy paintings are held in private collections around the world.\nFor me, painting is a way to preserve a moment and give it a sense of eternity.\n\nMember of the international art academy Acquarello; member of the international professional community International Watercolor Museum & Research Centre",
